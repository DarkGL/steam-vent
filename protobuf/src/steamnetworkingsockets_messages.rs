...
pub struct CMsgSteamNetworkingICESessionSummary {
    ...
    // @@protoc_insertion_point(field:CMsgSteamNetworkingICESessionSummary.p2p_transport_ice_enabled_convar)
    pub p2p_transport_ice_enabled_convar: ::std::option::Option<u32>,
    // @@protoc_insertion_point(field:CMsgSteamNetworkingICESessionSummary.local_candidates_types_allowed)
    pub local_candidates_types_allowed: ::std::option::Option<u32>,
    // special fields
...
impl CMsgSteamNetworkingICESessionSummary {
    ...
    pub fn p2p_transport_ice_enabled_convar(&self) -> u32 {
    ...
    pub fn local_candidates_types_allowed(&self) -> u32 {
...
impl ::protobuf::Message for CMsgSteamNetworkingICESessionSummary {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                112 => {
                    self.p2p_transport_ice_enabled_convar = ::std::option::Option::Some(is.read_uint32()?);
                },
                120 => {
                    self.local_candidates_types_allowed = ::std::option::Option::Some(is.read_uint32()?);
                },
                tag => {
                    ::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn default_instance() -> &'static CMsgSteamNetworkingICESessionSummary {
        static instance: CMsgSteamNetworkingICESessionSummary = CMsgSteamNetworkingICESessionSummary {
            ...
            p2p_transport_ice_enabled_convar: ::std::option::Option::None,
            local_candidates_types_allowed: ::std::option::Option::None,
            special_fields: ::protobuf::SpecialFields::new(),
        };
        &instance
    }
