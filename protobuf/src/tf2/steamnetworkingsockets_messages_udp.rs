...
//! Generated file from `tf2/steamnetworkingsockets_messages_udp.proto`
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n-tf2/steamnetworkingsockets_messages_udp.proto\x1a+steamnetworkingsock\
    ets_messages_certs.proto\x1a%steamnetworkingsockets_messages.proto\"\x9a\
    \x01\n%CMsgSteamSockets_UDP_ChallengeRequest\x12#\n\rconnection_id\x18\
    \x01\x20\x01(\x07R\x0cconnectionId\x12!\n\x0cmy_timestamp\x18\x03\x20\
    \x01(\x06R\x0bmyTimestamp\x12)\n\x10protocol_version\x18\x04\x20\x01(\rR\
    \x0fprotocolVersion\"\xba\x01\n#CMsgSteamSockets_UDP_ChallengeReply\x12#\
    \n\rconnection_id\x18\x01\x20\x01(\x07R\x0cconnectionId\x12\x1c\n\tchall\
    enge\x18\x02\x20\x01(\x06R\tchallenge\x12%\n\x0eyour_timestamp\x18\x03\
    \x20\x01(\x06R\ryourTimestamp\x12)\n\x10protocol_version\x18\x04\x20\x01\
    (\rR\x0fprotocolVersion\"\xa7\x04\n#CMsgSteamSockets_UDP_ConnectRequest\
    \x120\n\x14client_connection_id\x18\x01\x20\x01(\x07R\x12clientConnectio\
    nId\x12\x1c\n\tchallenge\x18\x02\x20\x01(\x06R\tchallenge\x12!\n\x0cmy_t\
    imestamp\x18\x05\x20\x01(\x06R\x0bmyTimestamp\x12\x1e\n\x0bping_est_ms\
    \x18\x06\x20\x01(\rR\tpingEstMs\x12>\n\x05crypt\x18\x07\x20\x01(\x0b2(.C\
    MsgSteamDatagramSessionCryptInfoSignedR\x05crypt\x127\n\x04cert\x18\x04\
    \x20\x01(\x0b2#.CMsgSteamDatagramCertificateSignedR\x04cert\x126\n\x17le\
    gacy_protocol_version\x18\x08\x20\x01(\rR\x15legacyProtocolVersion\x12'\
    \n\x0fidentity_string\x18\n\x20\x01(\tR\x0eidentityString\x123\n\x16lega\
    cy_client_steam_id\x18\x03\x20\x01(\x06R\x13legacyClientSteamId\x12^\n\
    \x16legacy_identity_binary\x18\t\x20\x01(\x0b2(.CMsgSteamNetworkingIdent\
    ityLegacyBinaryR\x14legacyIdentityBinary\"\x8a\x04\n\x1eCMsgSteamSockets\
    _UDP_ConnectOK\x120\n\x14client_connection_id\x18\x01\x20\x01(\x07R\x12c\
    lientConnectionId\x120\n\x14server_connection_id\x18\x05\x20\x01(\x07R\
    \x12serverConnectionId\x12%\n\x0eyour_timestamp\x18\x03\x20\x01(\x06R\ry\
    ourTimestamp\x12&\n\x0fdelay_time_usec\x18\x04\x20\x01(\rR\rdelayTimeUse\
    c\x12>\n\x05crypt\x18\x07\x20\x01(\x0b2(.CMsgSteamDatagramSessionCryptIn\
    foSignedR\x05crypt\x127\n\x04cert\x18\x08\x20\x01(\x0b2#.CMsgSteamDatagr\
    amCertificateSignedR\x04cert\x12'\n\x0fidentity_string\x18\x0b\x20\x01(\
    \tR\x0eidentityString\x123\n\x16legacy_server_steam_id\x18\x02\x20\x01(\
    \x06R\x13legacyServerSteamId\x12^\n\x16legacy_identity_binary\x18\n\x20\
    \x01(\x0b2(.CMsgSteamNetworkingIdentityLegacyBinaryR\x14legacyIdentityBi\
    nary\"\xb6\x01\n%CMsgSteamSockets_UDP_ConnectionClosed\x12(\n\x10to_conn\
    ection_id\x18\x04\x20\x01(\x07R\x0etoConnectionId\x12,\n\x12from_connect\
    ion_id\x18\x05\x20\x01(\x07R\x10fromConnectionId\x12\x14\n\x05debug\x18\
    \x02\x20\x01(\tR\x05debug\x12\x1f\n\x0breason_code\x18\x03\x20\x01(\rR\n\
    reasonCode\"{\n!CMsgSteamSockets_UDP_NoConnection\x12,\n\x12from_connect\
    ion_id\x18\x02\x20\x01(\x07R\x10fromConnectionId\x12(\n\x10to_connection\
    _id\x18\x03\x20\x01(\x07R\x0etoConnectionId\"\xc5\x01\n\x1aCMsgSteamSock\
    ets_UDP_Stats\x129\n\x05stats\x18\x01\x20\x01(\x0b2#.CMsgSteamDatagramCo\
    nnectionQualityR\x05stats\x12\x14\n\x05flags\x18\x03\x20\x01(\rR\x05flag\
    s\"V\n\x05Flags\x12\x13\n\x0fACK_REQUEST_E2E\x10\x02\x12\x19\n\x15ACK_RE\
    QUEST_IMMEDIATE\x10\x04\x12\x1d\n\x19NOT_PRIMARY_TRANSPORT_E2E\x10\x10*\
    \xa5\x02\n\x18ESteamNetworkingUDPMsgID\x12-\n)k_ESteamNetworkingUDPMsg_C\
    hallengeRequest\x10\x20\x12+\n'k_ESteamNetworkingUDPMsg_ChallengeReply\
    \x10!\x12+\n'k_ESteamNetworkingUDPMsg_ConnectRequest\x10\"\x12&\n\"k_ESt\
    eamNetworkingUDPMsg_ConnectOK\x10#\x12-\n)k_ESteamNetworkingUDPMsg_Conne\
    ctionClosed\x10$\x12)\n%k_ESteamNetworkingUDPMsg_NoConnection\x10%B\x05H\
    \x01\x80\x01\0J\xd1\x17\n\x06\x12\x04\0\0J\x01\n\t\n\x02\x03\0\x12\x03\0\
    ...
    \x03\x05\0\x01\x12\x03\x06\x05\x1d\n\x0b\n\x04\x05\0\x02\0\x12\x03\x07\
